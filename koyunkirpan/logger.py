...
f_err_handler = logging.FileHandler(filename=f'logs/error-{formatted_today}.log')
"""
...
f_runtime_handler = logging.FileHandler(filename=f'logs/runtime-{formatted_today}.log')
"""
...
f_debug_handler = logging.FileHandler(filename=f'logs/debug-{formatted_today}.log')
"""
